...
BEGIN{ use_ok( 'CGI::Session::Driver::mysql' ); }
require_ok( 'CGI::Session::Driver::mysql' );


BEGIN{ use_ok( 'CGI::Session::ExpireSessions' ); }
require_ok( 'CGI::Session::ExpireSessions' );
...
BEGIN{ use_ok( 'HTML::FromPod' ); }
require_ok( 'HTML::FromPod' );
...
BEGIN{ use_ok( 'Test::TAP::HTMLMatrix' ); }
require_ok( 'Test::TAP::HTMLMatrix' );


BEGIN{ use_ok( 'Test::TAP::Model::Visual' ); }
require_ok( 'Test::TAP::Model::Visual' );
