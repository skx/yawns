...
Yawns::Formatters::Markdown - A module for formatting Markdown text into HTML
...
=for example begin
    ...
    # Load the original
    my $html     = Yawns::Formatters::Markdown->new( text=> 'Some text\nhere');
...
package Yawns::Formatters::Markdown;
...
sub getPreview
{
    ...
    my $helper = Text::Markdown->new();
    my $html   = $helper->markdown($text);
